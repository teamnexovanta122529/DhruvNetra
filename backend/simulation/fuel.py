...
class FuelSubsystem:
    ...
    def evaluate_scenario_impact(
        ...
        return {
            ...
            "baseline_burn_rate_lph": baseline_burn_lph,
            "projected_burn_rate_lph": projected_burn_lph,
            "burn_rate_delta_lph": burn_rate_delta_lph,
            "total_fuel_saved_liters": total_fuel_delta_liters,
            "fuel_saved_liters": total_fuel_delta_liters,
